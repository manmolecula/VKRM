// Composable для логики работы с данными (API, состояние, фильтры)
// Эта функция идентична useMigratedSingleComponentLogic, но используется в Options API компоненте
import { ref, shallowRef, computed } from 'vue';
import { getLogEntries } from '@/api/activity-log';
import format from 'date-fns/format';

export function useActivityLogLogic() {
    // Состояние UI
